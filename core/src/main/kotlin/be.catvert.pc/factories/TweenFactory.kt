...
enum class TweenFactory(val tween: () -> TweenComponent.TweenData) {
    ...
    RemoveGOTween({ TweenComponent.TweenData("remove tween", GameObjectTweenAccessor.GameObjectTween.SIZE_Y, floatArrayOf(0f), 0.5f, arrayOf(AnimationComponent::class.java, AtlasComponent::class.java, TextureComponent::class.java), RemoveGOAction()) });
