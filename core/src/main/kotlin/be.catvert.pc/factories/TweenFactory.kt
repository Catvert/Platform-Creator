...
enum class TweenFactory(val tween: () -> TweenComponent.TweenData) {
    ...
    RemoveGOTween({ TweenComponent.TweenData("removeItem tween", GameObjectTweenAccessor.GameObjectTween.SIZE_Y, floatArrayOf(0f), 0.5f, arrayOf(AtlasComponent::class.java, TextureComponent::class.java), RemoveGOAction()) });
